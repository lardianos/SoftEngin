...
-- ----------------------------
INSERT INTO `Categories` VALUES ('1', ' Church');
...
INSERT INTO `Categories` VALUES ('7', 'Castle');
INSERT INTO `Categories` VALUES ('8', 'Allo');
...
-- Records of Points
-- ----------------------------
INSERT INTO `Points` VALUES ('1', 'Spileo Agiou Ioani', 'To sphlaio toy Agioy Iwannh toy Erhmith h toy Ksenoy brisketai konta sto faraggi Aylaki, Akrwthrioy Xaniwn, molis merikes ekatontades metra makrytera apo thn Arkoydosphlia, sthn ereipwmenh Monh Katholikoy kai konta sth Monh Goybernetoy. Omoiws me thn Arkoydosphlia, einai kai ayto palaia koith potamoy me synoliko mhkos peripoy 135m. se morfh orizontias galarias. Exei ploysio diakosmo se polla shmeia me megaloys stalaktites kai stalagmites.', '0', '5', 'Marathokefala');
...
INSERT INTO `Points` VALUES ('3', 'Kastro Kasteliou', 'To Kastelli ths Kissamou, pou apo to 1966 metonomasthke se Kissamo, einai mia mikrh grafikh kwmopolh apo aplwnetai ston myxo tou Kolpou Myrtilos h Kisamou, anamesa stis Xersonhsous ths Grambousas kai ths Spathas. To onoma ths to ofeilei sto enetiko frourio pou htan ktismeno ekei.', '0', '7', 'Kasteli');
INSERT INTO `Points` VALUES ('4', 'Kastro Gramvousas', 'TO SHMERINO KASTRO THS GRAMBOYSAS, KTIS8HKE TON 16O AIwNA (1579-1584) APO TOYS ENETOYS, OI OPOIOI EBLEPAN THN TOYRKIKH EPEKTATIKOTHTA. PROKEITAI GIA ENA ARISTOYRGHMA OXYRwMATIKHS TEXNHS GIA THN EPOXH EKEINH, TO OPOIO METEBALAN SE APOR8HTO FROYRIO.', '0', '7', 'Kissamos');
